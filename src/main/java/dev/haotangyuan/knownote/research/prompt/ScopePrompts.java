package dev.haotangyuan.knownote.research.prompt;
...
public class ScopePrompts {
    public static final String CLARIFY_WITH_USER_INSTRUCTIONS = """
    ...
    public static final String TRANSFORM_MESSAGES_INTO_RESEARCH_TOPIC_PROMPT = """
